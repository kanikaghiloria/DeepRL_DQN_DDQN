...
class GameState:
    def __init__(self):
        ...
        # self.pipe_group = pygame.sprite.Group([self.upperPipes, self.lowerPipes])
    ...
    def getGameState(self):
        ...
        state = []
        state.append('player_vel' + ' ' + self.playerVelY)
    ...
    def frame_step(self, input_actions):
        ...
        # print(self.score)
        return image_data, reward, terminal, self.score, final_score
...
def getRandomPipe():
    ...
    return [
        ...
        {'x': pipeX, 'y': gapY + getRandomPipeGapSize()},  # lower pipe
    ]
