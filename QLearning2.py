...
# a_file = open("logs_" + GAME + "/readout_test.txt", 'a+')
# h_file = open("logs_" + GAME + "/hidden_test.txt", 'a+')
# out_file = open("logs_" + GAME + "/output_test.txt", 'a+')
###############################

# printing
outputFile = "/output.txt"
a_file = open("logs_" + GAME + "/readout.txt", 'a+')
h_file = open("logs_" + GAME + "/hidden.txt", 'a+')
out_file = open("logs_" + GAME + "/output.txt", 'a+')
OBSERVE = 10000
# OBSERVE = easy
EXPLORE = 3000000
...
def trainNetwork(sess):
    ...
    while "flappy bird" != "angry bird":
        ...
        if(final_score > 0):
            ...
            with open("logs_" + GAME + outputFile, 'a') as fout:
